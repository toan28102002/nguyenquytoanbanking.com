										...
										<div class="card-body">
											<ul class="mb-4 text-white list-unstyled">
												<li> 
													...
													<p class="text-white h5">{{ Auth::user()->s_curr }}{{ number_format($method->minimum) }}</p>
												</li>
												<li>
													<small>Maximum withdrawable amount</small>
													<p class="text-white h5">{{ Auth::user()->s_curr }}{{ number_format($method->maximum )}}</p>
												</li>
												...
												<li>
													...
													<strong>
														...
														@else
															{{ Auth::user()->s_curr }}{{ $method->charges_amount }}
														@endif
													</strong>
												</li>
												<li>
